...
export default function WordDetailPage() {
  ...
  return (
    <div className="detail-card">
      ...
      {word.imageUrl && (
        <img className="word-image" src={word.imageUrl} alt={`Ilustrasi ${word.lexem}`} />
      )}
      ...
      {word.example && (
        <div className="example">
          ...
          {word.example_gloss && <div className="gloss">“{word.example_gloss}”</div>}
        </div>
      )}
            ...
            {senses.map((s) => (
              <li key={s.id}>
                ...
                {s.example && (
                  <div className="example">
                    <div>{s.example}</div>
                    {s.example_gloss && <div className="gloss">“{s.example_gloss}”</div>}
                  </div>
                )}
              </li>
            ))}
