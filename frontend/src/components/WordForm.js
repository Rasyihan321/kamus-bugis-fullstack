...
export default function WordForm({ initial = {}, submitLabel, onSubmit }) {
  ...
  return (
    <form className="form-card" onSubmit={handleSubmit}>
      ...
      <input value={form.lexem} onChange={set('lexem')} placeholder="mis. anre" />
      ...
      <input value={form.phonetic_form} onChange={set('phonetic_form')} placeholder="mis. an.re" />

      <label>Contoh kalimat (Bugis)</label>
      <input value={form.example} onChange={set('example')} placeholder="mis. anre ni mai" />
