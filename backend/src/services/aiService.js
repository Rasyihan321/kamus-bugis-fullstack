...
async function generateWithOllama(message, word, entries) {
  ...
  const system = [
    ...
    "Jika pengguna menanyakan bahasa Bugis dari sebuah kata Indonesia, jawab dengan lema Bugis dari data kamus (bukan kata Indonesianya).",
    `Jika pengguna meminta contoh kalimat, buat 3 contoh kalimat bahasa Bugis yang natural (gunakan kata Bugis "${word}" bila relevan), format daftar bernomor: kalimat Bugis, lalu terjemahan Indonesia di baris berikutnya dengan awalan '→'.`,
